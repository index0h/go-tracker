...
var Track_Visit_DEFAULT *Visit

func (p *Track) GetVisit() *Visit {
	if !p.IsSetVisit() {
		return Track_Visit_DEFAULT
	}
	return p.Visit
}

func (p *Track) GetFlashes() []*Flash {
	return p.Flashes
}
func (p *Track) IsSetVisit() bool {
	return p.Visit != nil
}
...
func (p *Track) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *Track) writeField2(oprot thrift.TProtocol) (err error) {
...
type Mark struct {
	...
	Fields     map[string]string   `thrift:"fields,3" json:"fields"`
	FieldLists map[string][]string `thrift:"fieldLists,4" json:"fieldLists"`
}
...
func (p *Mark) GetMarkID() string {
	return p.MarkID
}

func (p *Mark) GetClientID() string {
	return p.ClientID
}

func (p *Mark) GetFields() map[string]string {
	return p.Fields
}

func (p *Mark) GetFieldLists() map[string][]string {
	return p.FieldLists
}
func (p *Mark) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return fmt.Errorf("%T read error: %s", p, err)
	}
	for {
...
func (p *Mark) Write(oprot thrift.TProtocol) error {
...
func (p *Mark) writeField4(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("fieldLists", thrift.MAP, 4); err != nil {
		return fmt.Errorf("%T write field begin error 4:fieldLists: %s", p, err)
	}
	if err := oprot.WriteMapBegin(thrift.STRING, thrift.LIST, len(p.FieldLists)); err != nil {
		return fmt.Errorf("error writing map begin: %s", err)
	}
	for k, v := range p.FieldLists {
		if err := oprot.WriteString(string(k)); err != nil {
			return fmt.Errorf("%T. (0) field write error: %s", p, err)
		}
	...
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 4:fieldLists: %s", p, err)
	}
	return err
}

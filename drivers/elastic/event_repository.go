...
func NewEventRepository(client *driver.Client, uuid common.UUIDProviderInterface) (*EventRepository, error) {
	if client == nil {
...
func (repository *EventRepository) FindByID(id common.UUID) (*entities.Event, error) {

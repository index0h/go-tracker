...
type Repository struct {
	...
	nested components.EventRepositoryInterface
}

func NewRepository(nested components.EventRepositoryInterface) (result *Repository, err error) {
	result = &Repository{
...
func (repository *Repository) FindByID(eventID common.UUID) (result *entities.Event, err error) {
